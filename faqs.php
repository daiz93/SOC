...
<title>FAQs | Fundz - Crowdfunding HTML5 Template</title> 
...
<div class="wrapper"> 
  ...
  <header>
    <div class="container">
      <div id="logo">
        <a href="index.html"><img src="assets/images/logo.png" alt="Fundz" /></a>
    ...
    <article class="container faqpage">
      <div class="row">
          ...
          <div class="accordion" id="accordion-faq">
            ...
            <div class="accordion-group">
              <div class="accordion-heading">
                <a class="accordion-toggle" data-toggle="collapse" href="#collapseThree1">
                  Pellentesque pharetra sapien non quam placerat vestibulum ?
                  <span class="updown-cion"></span>
                </a>
              </div>
            ...
            <div class="accordion-group">
              <div class="accordion-heading">
                <a class="accordion-toggle" data-toggle="collapse" href="#collapseThree2">
                  Pellentesque pharetra sapien non quam placerat vestibulum ?
                  <span class="updown-cion"></span>
                </a>
              </div>
