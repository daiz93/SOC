...
<title>Single Page | Fundz - Crowdfunding HTML5 Template</title>
...
<div class="wrapper"> 
  ...
  <header>
    <div class="container">
      <div id="logo"> <a href="index.html"><img src="assets/images/logo.png" alt="Fundz" /></a>
        <button type="button" class="collapsed" id="navbar-toggle"><i class="icon fa fa-bars"></i></button>
      </div>
      <div class="nav-header-right">
        <nav class="main-nav">
          <ul>
            <li><a href="about.html">About Us <span>what is fundz?</span></a></li>
            <li><a href="projects.html">Explore <span>amazing ideas</span></a>
              <ul>
            ...
            <li><a href="start.html">Start <span>send your idea</span></a></li>
        ...
        <div class="header-right">
          <div class="header-right-btns">
            <ul>
              <li><a href="#" class="btn btn-4 blue">Donate</a></li>
            </ul>
          </div>
  ...
  <section class="gray">
    <article class="container faqpage">
      <div class="row">
        <figure> <img src="assets/images/slide-2.jpg" alt="Image" /> </figure>
        <div class="col-lg-12">
          <div class="single-page">
            <h3>Integer vehicula placerat erat, quis varius velit</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse in semper nisi. Pellentesque sit amet aliquet nisi. Vestibulum eget rhoncus augue. Curabitur suscipit euismod felis et rutrum. Sed sollicitudin laoreet dapibus.</p>
            <p>In placerat elementum sapien, vel lobortis arcu fringilla a. Proin vitae nulla in enim elementum rutrum quis id tortor. Ut orci ante, sollicitudin et nunc nec, posuere gravida metus.</p>
            <blockquote><i class="fa fa-quote-left"></i>Lorem ipsum dolor sit amet, consecte adipiscing elit. Integer aliquam mi nec dolor placerat a condimentum diam mollis. Ut pulvinar neque eget massa dapibus dolor. Proin pharetra ultrices metus eget auctor. Sed nunc magna, faucibus ut arcu quis, aliquam consequat lorem.</blockquote>
            <p>Proin pharetra ultrices metus eget auctor. Sed nunc magna, faucibus ut arcu quis, aliquam consequat lorem. Mauris cursus ante non suscipit ultrices. Morbi scelerisque ante viverra erat tristique commodo. Mauris rhoncus diam at faucibus auctor. Sed volutpat, risus et blandit efficitur, felis ante dapibus metus, in aliquam odio elit at odio. Proin et arcu mollis, auctor nisi at, pulvinar mi. Nunc condimentum erat laoreet justo congue, a porttitor quam tristique. Nunc accumsan nunc nulla, et laoreet diam porta et. Aenean pharetra risus ac risus ullamcorper, vitae egestas dui egestas.</p>
            <ul>
            ...
            <h6>Curabitur suscipit euismod felis et rutrum</h6>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse in semper nisi. Pellentesque sit amet aliquet nisi. Vestibulum eget rhoncus augue. Curabitur suscipit euismod felis et rutrum. Sed sollicitudin laoreet dapibus.</p>
            <p>In placerat elementum sapien, vel lobortis arcu fringilla a. Proin vitae nulla in enim elementum rutrum quis id tortor. Ut orci ante, sollicitudin et nunc nec, posuere gravida metus.</p>
            <p>Proin pharetra ultrices metus eget auctor. Sed nunc magna, faucibus ut arcu quis, aliquam consequat lorem. Mauris cursus ante non suscipit ultrices. Morbi scelerisque ante viverra erat tristique commodo. Mauris rhoncus diam at faucibus auctor. Sed volutpat, risus et blandit efficitur, felis ante dapibus metus, in aliquam odio elit at odio. Proin et arcu mollis, auctor nisi at, pulvinar mi. Nunc condimentum erat laoreet justo congue, a porttitor quam tristique. Nunc accumsan nunc nulla, et laoreet diam porta et. Aenean pharetra risus ac risus ullamcorper, vitae egestas dui egestas.</p>
  ...
  <section class="send-us">
    <article class="container">
      ...
      <a href="start.html" class="btn btn-3 green">Send to us</a> </article>
  </section>
  ...
  <footer> 
    ...
    <div class="container footer-links">
      <div class="row">
        <div class="col-lg-4 footer-about"> <img src="assets/images/footer-logo.png" alt="Fundz" />
        ...
        <div class="col-lg-2">
          ...
          <ul class="contact-info">
            <li><i class="fa fa-map-marker"></i> <span>2 Abc Road City, London<br />
              UK AB12CD</span></li>
    ...
    <!-- ************************ CopyRights & NewsLetter SignUp ************************ -->
    
    <div class="copyrights">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 copyright-text"> &copy; 2015 Fundz | All rights reserved. </div>
          <div class="col-lg-6 newsletter"> Subscribe for our newsletter
